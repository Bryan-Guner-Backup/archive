if (self.CavalryLogger) {
    CavalryLogger.start_js(["tadR8LZ"]);
}
...
__d("BigPipe", ["$", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "ErrorUtils", "FBLogger", "HasteResponse", "JSCC", "PageEvents", "PageletEventConstsJS", "PageletSet", "RunBlue", "ServerJS", "TimeSlice", "UserTimingUtils", "captureUsageSnapshot", "clearTimeout", "createTrustedFunction", "createTrustedScriptWithoutValidation_DO_NOT_USE", "fastDeepCopy", "ge", "gkx", "performanceAbsoluteNow", "requireDeferred", "setTimeout"], (function(a, b, c, d, e, f, g) {
    ...
    b = function() {
        ...
        b._downloadJsForPagelet = function(a) {
            this._informPageletEvent(c("PageletEventConstsJS").JS_START, a), c("Bootloader").loadResources(a.allResources || [], {
                onAll: function() {
                    var b = this;
                    this._informPageletEvent(c("PageletEventConstsJS").JS_END, a);
        ...
        onPageletArrive: c("ErrorUtils").guard(function(a) {
            ...
            n = function() {
                ...
                c("Bootloader").loadResources(b, {
                    onAll: function() {
                        this._informPageletEvent(c("PageletEventConstsJS").CSS_END, a), this.arbiter.inform(a.id + "_css_end", !0, "state")
                    }.bind(e)
                }, a.id)
            };
...
__d("PhotoSnowliftLoader", ["Arbiter", "Bootloader", "FBLogger", "PageEvents", "getSurfaceAwareContainer", "ifRequired", "snowliftLoadingSpinner"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, d) {
        ...
        c("Bootloader").loadModules(["URI"], function(f) {
            ...
            h = r(h, a, b, g);
            if (h) {
                b.getAttribute("data-ploi") && (h = new Image(), h.src = new f(s(b)));
    ...
    function b(a, b, d, e) {
        q(d), c("Bootloader").loadModules(["Live", "PhotoTagApproval", "PhotoTagger", "PhotoTags", "TagTokenizer"], function() {}, "PhotoSnowliftLoader"), c("Bootloader").loadModules(["PhotoSnowlift"], function(c) {
            c.bootstrap(a, b)
        }, e)
    }
    var q = function(a) {
