                    ...
                    i = {
                        ...
                        methods: {
                            displayMessages: function(t) {
                                ...
                                if (p.length > 0 && "c" === n.type && ((a = p[p.length - 1]).ownerId === n.ownerId ? (n.blockId = a.blockId, a.messages.push(n)) : a = null), n.timeStamp > this.lastMessageTimestamp && ("v" === n.senderType ? this.$store.dispatch("session/updateVisitorChatSeen", n.timeStamp) : (this.unseenMessages.push(n), d && !this.isLoading || this.barMessageId || (n.showBar = !0, this.barMessageId = n.messageId, this.barMessageRerence = n))), l && "a" === n.senderType && n.data && n.data.rsc && this.removeAgentIsTyping(n.data.rsc), n.isCallView) {
