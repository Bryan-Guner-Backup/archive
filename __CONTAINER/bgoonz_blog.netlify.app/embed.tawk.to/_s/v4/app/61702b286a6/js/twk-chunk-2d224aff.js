    ...
    ["chunk-2d224aff"], {
        e0ca: function(t, e, i) {
            ...
            var w = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/61702b286a6", "/css/min-widget.css"),
                            isLoaded: !1,
                            clickEvent: "touchend",
                            resizeWidth: 0
                        }
                        ...
                        styleObject: function() {
                            ...
                            if (this.mobileBrowserName ? (t = this.xOffsetMobile, e = this.yOffsetMobile) : (t = this.xOffset, e = this.yOffset), this.isRTL ? this.isRight ? a["right:"] = "".concat(t, "px !important;") : a["left:"] = "".concat(t, "px !important;") : this.isRight ? a["right:"] = "".concat((t - 4) * this.zoomRatio, "px !important;") : a["left:"] = "".concat(t * this.zoomRatio, "px !important;"), this.isCenter) {
                                if (a["top:"] = "calc(50% - ".concat(.5 * i.height, "px) !important;"), !this.isRoundWidget) {
                                    var o = .5 * i.height - .5 * i.width,
                                        n = "49% !important",
                                        s = "rotate(".concat(this.isRight ? "-90deg" : "90deg", ") !important");
                                    this.mobileBrowserName ? (n = "0 0 !important", this.isRight ? (a["left:"] = "calc(100% - ".concat(this.iFrameHeight, ") !important;"), s = "rotate(-90deg) translateX(-50%) !important") : (a["right:"] = "85% !important;", a["left:"] = "".concat(this.iFrameHeight, " !important;"), s = "rotate(90deg) translateX(-50%) !important")) : this.isRight ? a["right:"] = "".concat(o, "px !important;") : a["left:"] = "".concat(o, "px !important;"), a["transform-origin:"] = n, a["-webkit-transform:"] = "".concat(s, ";"), a["-ms-transform:"] = "".concat(s, ";"), a["transform:"] = "".concat(s, ";")
                                }
