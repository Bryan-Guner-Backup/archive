! function() {
    ...
    var H = /[^:]+:\/\/[^(/|?)\s]+/,
        ...
        R = (RegExp("^[\0-]*(" + W("javascript") + "|" + W("data") + "):", "i"), /^((http(s)?:)?\/\/)/),
        V = function(e) {
            return function(n, t) {
                if (0 === n) {
    ...
    function He(e, n) {
        return null != n && null != e && "object" == typeof n && "object" == typeof e ? Be(n, e) : e
    }
    ...
    function Be(e, t) {
        ...
        if (Array.isArray(e)) {
            ...
            for (var o = 0; t.length > o; o++) void 0 !== t[o] && (i[o] = He(t[o], i[o]))
        } else
            for (var a in i = n({}, e), t) r(a, t) && (void 0 === t[a] ? delete i[a] : i[a] = He(t[a], i[a]));
        return i
    }
    var We = function(n) {
            return new e((function(e) {
    ...
    var Nt = {
        ...
        Wt = function() {
            ...
            var r = function() {
                var e, i = b(t);
                return i ? (e = i, Bt() - e.startTime + e.duration) : Bt() - n
            };
            return {
                disconnect: function() {
                    return i.disconnect()
    ...
    var Kt, Qt, Zt, ei, ni = "__test_storage_support__",
        ...
        yi = function(e, n, t, i, r) {
            e.call("storeMethod", ["setLocalization", i]), t.custom || vt(t.element, (function() {
                ...
                function(e, n, t) {
                    Sn(e, n, t), "LiveChatWidget" in window && Hn(e, n, t)
