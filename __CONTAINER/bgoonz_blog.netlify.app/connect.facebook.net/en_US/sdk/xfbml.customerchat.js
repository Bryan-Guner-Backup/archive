/*1635470457,,JIT Construction: v1004637598,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("UserAgentData", [], {
                    ...
                    "browserFullVersion": "211.0.0.21.118",
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1004637598","namespace":"FB","message":"' + e.message + '"}}');
